...
function fallback(gameType, c) {
  ...
  switch (gameType) {
    ...
    case 'parallel-letters': {
      ...
      text += `${nickname || '你'}读了两封来自未来的信——一封来自「${optionA || '选项A'}」的未来，一封来自「${optionB || '选项B'}」的未来。两封信都不是预言，是镜子。它们在问的不是"哪条路更好"，而是"你更想成为哪种人"。\n\n`;
      ...
      text += `在「${optionA || 'A'}」的未来里，你读到的是一种生活。那种生活有它自己的气味、节奏、得失。在「${optionB || 'B'}」的未来里，你读到的是另一种。两条路都可以走，都能活，都有人走通过。没有哪条是错的。\n\n`;

      text += `但有一个问题只有你自己能回答。问自己：读完两封信之后，哪一个未来的画面让你心跳快了一点？不是哪个更合理，不是哪个更安全，是哪个让你突然觉得"如果真的是这样，好像也不错"——那种"也不错"的感觉，就是答案。\n\n`;

      text += `信不是在帮你看未来，是在帮你看现在。你现在怕什么，你现在渴望什么，你现在最需要什么——信都在帮你翻译。你读完之后的感受，就是你内心最真实的GPS。\n\n`;

      text += `回到你的问题「${optionA || 'A'} vs ${optionB || 'B'}」——现在你知道了，纠结不是问题，不纠结才是问题。一个完全不纠结的选择，说明你没有认真对待它。你现在的纠结，是你认真的证据。带着这个看清楚的心情，去选。选完不要回头看，因为另一条路永远会在你想象里更好。走下去，把你选的这条路走成最好的那条。`;
