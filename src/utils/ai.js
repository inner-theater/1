...
function generateMockLetter(year, optionA, optionB) {
  ...
  const theOther = theChoice === optionA ? optionB : optionA;

  const letters = {
    1: `选了「${theChoice}」之后一整年了。\n\n说真的，跟我想的完全不一样——不是更好，也不是更坏，就是完全不一样。我以为自己会很明确地"做对了"或者"后悔了"，但其实大多数时候根本顾不上想这些。生活用无数具体的事填满了每一天——适应新环境、认识新的人、处理之前没遇到过的问题。偶尔夜深人静会想一下：当初如果选了「${theOther}」会怎样？但也只是想一下，然后翻身就睡了。\n\n最大的感受是：选择本身没我以为的那么重要。重要的是选了之后我没停在原地。这一年最大的成长不是"选对了"，而是"选了之后一直在走"。你现在怕的那些事大多数不会发生，发生的那些也没有你想的那么可怕。\n\n—— 一年后`,

    3: `嘿，三年了。\n\n当初选「${theChoice}」的那个纠结，现在已经不是问题了。不是解决了——是有更大的问题了。成年人的生活就是这样，永远有下一个坎要迈。\n\n这三年里，我做了很多当初没想过的事。选「${theChoice}」这条路上有真实的收获——可能是一份工作、一个圈子、一种生活方式，让我变成了一个跟三年前不一样的人。但也有真实的遗憾——偶尔会想，走了「${theOther}」那条路的人现在在干嘛？他们看到的世界跟我看到的是不是完全不一样？\n\n不过这种遗憾很浅——浅到不会影响我做任何决定。它只是偶尔飘过，像公交车站看到一辆去往不同方向的班车。你上了这辆车，就好好坐到底。风景不一样，但终点站都挺远的。\n\n—— 三年后`,

    10: `十年了，没想到吧。\n\n「${theChoice}」跟「${theOther}」——这对十年前的你来说是整个宇宙。十年后的我可以告诉你：它在人生的长河里的分量，大概就像你高中时选文科还是理科。它改变了一些轨迹，但没有定义你是什么样的人。\n\n真正定义我的，是选了之后每一天的选择——怎么对待工作、怎么对待身边人、在低谷时怎么跟自己对话、被打击后多久爬起来。这些事跟「${theChoice}」或「${theOther}」都没关系。哪条路都会有这些挑战，区别只是它们的包装不一样。\n\n最后说一句：别怕。十年前我怕了太久——怕选错、怕后悔、怕辜负。现在回头看，怕本身才是唯一真正浪费掉的东西。至于选哪条路——选哪条都行，选完走下去就行。\n\n—— 十年后`,
  };
